...
startup
{
	settings.Add("ASL Version 2.4 - November 1, 2019", false);
...
start
{
	return (current.IGTframes == 0 && old.PlayerControl == 1 && current.PlayerControl == 0 && current.Stage == 1 && current.CameraX == 600 && current.PlayerX < 600 && current.PlayerX != 560)
