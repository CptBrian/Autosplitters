...
state("YLILWin64", "Unknown Version"){     //Defaults to Steam 1.03 values
	...
	byte restartTrigger : "mono.dll", 0x002675E0, 0xA0, 0x300, 0x0, 0x60;
	byte beeBreak : "mono.dll", 0x002675E0, 0x40, 0xE30, 0x90;
	byte interactableBook : "mono.dll", 0x002675E0, 0xA0, 0xC28, 0x8, 0x20, 0x30, 0x20, 0x18, 0x78, 0x50, 0x58, 0xA4;
...
state("YLILWin64", "Steam 1.01"){
	...
	int owTonics : "UnityPlayer.dll", 0x0144DBD8, 0x8, 0x8, 0x8, 0x2D8, 0x28, 0x18, 0x28; //Unconfirmed
...
state("YLILWin64", "EGS 1.02"){
	...
	byte interactableBook : "mono-2.0-bdwgc.dll", 0x0043ECC0, 0xA8, 0xC78, 0x8, 0x18, 0x58, 0x20, 0x18, 0x78, 0x50, 0x58, 0xA4;
...
state("YLILWin64", "Steam 1.03"){
	...
	byte restartTrigger : "mono.dll", 0x002675E0, 0xA0, 0x300, 0x0, 0x60;
	byte beeBreak : "mono.dll", 0x002675E0, 0x40, 0xE30, 0x90;
	byte interactableBook : "mono.dll", 0x002675E0, 0xA0, 0xC28, 0x8, 0x20, 0x30, 0x20, 0x18, 0x78, 0x50, 0x58, 0xA4; //Same ptr as control
	byte playerControl : "mono.dll", 0x002675E0, 0xA0, 0xC28, 0x8, 0x20, 0x30, 0x20, 0x18, 0x78, 0x50, 0x58, 0xA6; //Stable so far
	int owTonics : "UnityPlayer.dll", 0x0144DBD8, 0x8, 0x8, 0x8, 0x2D8, 0x28, 0x18, 0x28;
	int beeTotal : "mono.dll", 0x002675E0, 0x88, 0x10, 0x1F0, 0x40, 0x8, 0x30, 0x30, 0x20, 0x40, 0x8, 0x30, 0x2C;
	int Level : "mono.dll", 0x002675E0, 0xA0, 0x3A8, 0x18, 0xC8;
	byte LevelLoad : "mono.dll", 0x002675E0, 0xA0, 0x3A8, 0x18, 0xD0;
...
state("YLILWin64", "Demo 1.03"){
	...
	byte beeBreak : "mono.dll", 0x002675E0, 0x40, 0xE30, 0x90;
	byte interactableBook : "mono.dll", 0x002675E0, 0xA0, 0xC28, 0x8, 0x20, 0x30, 0x20, 0x18, 0x78, 0x50, 0x58, 0xA4; //Unconfirmed
	byte playerControl : "mono.dll", 0x002675E0, 0xA0, 0xC28, 0x8, 0x20, 0x30, 0x20, 0x18, 0x78, 0x50, 0x58, 0xA6; //Unconfirmed
	int owTonics : "UnityPlayer.dll", 0x0144DBD8, 0x8, 0x8, 0x8, 0x2D8, 0x28, 0x18, 0x28; //Unconfirmed
	int beeTotal : "mono.dll", 0x002675E0, 0x88, 0x10, 0x1F0, 0x40, 0x8, 0x30, 0x30, 0x20, 0x40, 0x8, 0x30, 0x2C; //Unconfirmed
	int Level : "mono.dll", 0x002675E0, 0xA0, 0x3A8, 0x18, 0xC8; //Unconfirmed
	byte LevelLoad : "mono.dll", 0x002675E0, 0xA0, 0x3A8, 0x18, 0xD0; //Unconfirmed
...
start{
	if(settings[vars.ILRunsMode] && current.restartTrigger == 1 && current.playerControl == 1 && old.playerControl == 0 && current.interactableBook != 1 && !settings["TestDelaysRestart"] && !settings["TestDelaysBeeBreakToLoad"]){
		vars.Log("-Starting-\n");
		return true;						        //Start timer for normal ILs
	}
	else if(settings["TestDelaysRestart"] && current.restartTrigger == 0 && !settings["TestDelaysBeeBreakToLoad"]){
		vars.Log("-Starting-\n");
...
reset{
	if(current.restartTrigger == 0 && old.restartTrigger == 1 && (settings[vars.ILRunsMode] || settings["TestDelaysRestart"])){
		vars.Log("-Resetting-\n");
