...
state("BloodstainedRotN-Win64-Shipping", "Unknown-Using Latest"){ //Copy of addresses from whichever the most common version is (Steam 1.6 EOS)
	...
	uint BossHP : 0xB164D00, 0x408, 0xD30, 0x240;
	uint Gold : 0xB164D00, 0x430;
	float IGT : 0xB164D00, 0x444;
	byte Difficulty : 0xB164D00, 0x448;
	byte GameMode : 0xB164D00, 0x449;
	byte Character : 0xB164D00, 0x44A;
	uint IntroEvents : 0xB164D00, 0x4E8;
	byte BossDoors : 0xB164D00, 0x930;
	byte GalleonBannerSeen : 0xB164D00, 0x940;
	uint PauseMenu : 0xB164D00, 0xA28;
	uint PressAnyKey : 0xB164D00, 0xA38;
	uint Loading : 0xB164D00, 0xA50;
	uint LoadingFile : 0xB164D00, 0xA60;
	uint RoomData : 0xB164D00, 0x2F8B0;
	uint PreviousRoom : 0xB164D00, 0x2F8B0, 0x188;
	uint Room : 0xB164D00, 0x2F8B0, 0x190;
	byte RDLoading : 0xB164D00, 0x2F8B0, 0x1B8;
	byte IntroChest : 0xB164D00, 0x2E8B5;
	uint DialogueShop : 0xB164D00, 0x2F988, 0x4E8;
	float PlayerRotation : 0xB164D00, 0x2FA38, 0x0, 0x900, 0x23C;
	float PlayerX : 0xB164D00, 0x2FA38, 0x0, 0x900, 0x260;
	float PlayerY : 0xB164D00, 0x2FA38, 0x0, 0x900, 0x268;
	float PlayerZ : 0xB164D00, 0x2FA38, 0x0, 0x900, 0x264;
	uint PlayerHP : 0xB164D00, 0x2FA38, 0x0, 0xD30, 0x240;
	uint PlayerMP : 0xB164D00, 0x2FA38, 0x0, 0xD30, 0x244;
	uint PlayerEXP : 0xB164D00, 0x2FA38, 0x0, 0xD30, 0x248;
	uint Classic1Score : 0xB156F80, 0xC4;
	float Classic1HP : 0xB156F80, 0xB8;
	float Classic1Time : 0xB156F80, 0xD0, 0x548;
	bool Classic1TimeRunning : 0xB156F80, 0xD0, 0x540;
	float Classic1PlayerX : 0xB156F80, 0xD0, 0x7E8, 0x4A0, 0x548, 0x2D0;
	float Classic1PlayerY : 0xB156F80, 0xD0, 0x7E8, 0x4A0, 0x548, 0x2D8;
	float Classic1PlayerZ : 0xB156F80, 0xD0, 0x7E8, 0x4A0, 0x548, 0x2D4;
	float Classic1Stage5Time : 0xB164D00, 0x468, 0x58;
}
