...
state("YookaLaylee64", "Unknown - Using Latest"){
	byte Loading : "YookaLaylee64.exe", 0x12C5790, 0x8, 0x10, 0x28, 0x18, 0x20, 0x66;
	byte LoadingFade : "YookaLaylee64.exe", 0x12C5790, 0x8, 0x10, 0x28, 0x18, 0x20, 0x65; //Not sure what this byte really is, not consistent for fades.
	byte LoadingBase : "YookaLaylee64.exe", 0x12C5790, 0x8, 0x10, 0x28, 0x18, 0x20, 0x64;
	...
	int spendablePagies: "YookaLaylee64.exe", 0x12C5790, 0x8, 0x10, 0x28, 0x18, 0x20, 0x20, 0x10, 0x2C; //Number of spendable pagies - NEEDS UPDATE
	byte Lag : "mono.dll", 0x265180, 0x50, 0x228, 0x30, 0x30, 0x30, 0x18, 0x20, 0x18, 0x80, 0x70, 0x78, 0x69;
}
...
state("YookaLaylee64", "Steam 1.1.0 (2019)"){
	...
	float CameraY: "AkSoundEngine.dll", 0x19877C; //Height of the camera - Note: AkSoundEngine.dll isn't very reliable and these have failed in the past.
	float CameraZ: "AkSoundEngine.dll", 0x198780; //Z coord of the camera
	int spendablePagies: "YookaLaylee64.exe", 0x12C5790, 0x8, 0x10, 0x28, 0x18, 0x20, 0x20, 0x10, 0x2C; //Number of spendable pagies
	byte Lag : "mono.dll", 0x2645E0, 0x40, 0x1018, 0x0, 0x18, 0x40, 0x18, 0x78, 0x68, 0x70, 0x69;
}
...
state("YookaLaylee64", "GOG 1.1.0 (2019)"){
	byte Loading : "YookaLaylee64.exe", 0x12C5790, 0x8, 0x10, 0x28, 0x18, 0x20, 0x66;
	byte LoadingFade : "YookaLaylee64.exe", 0x12C5790, 0x8, 0x10, 0x28, 0x18, 0x20, 0x65; //Not sure what this byte really is, not consistent for fades.
	byte LoadingBase : "YookaLaylee64.exe", 0x12C5790, 0x8, 0x10, 0x28, 0x18, 0x20, 0x64;
	float CameraX: "AkSoundEngine.dll", 0x198778; //X coord of the camera
	...
	float CameraZ: "AkSoundEngine.dll", 0x198780; //Z coord of the camera
	int spendablePagies: "YookaLaylee64.exe", 0x12C5790, 0x8, 0x10, 0x28, 0x18, 0x20, 0x20, 0x10, 0x2C; //Number of spendable pagies
	byte Lag : "YookaLaylee64.exe", 0x13246A0, 0x0, 0xA0, 0x0, 0xF8, 0x10, 0xC8, 0x194;
}
...
init{
	...
	else if(vars.MD5Hash == "717D8743DAB659FAE6F42EACB39E3B3D") {
		version = "GOG 1.1.0 (2019)";
	}
